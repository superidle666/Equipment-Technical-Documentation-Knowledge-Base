...
from processor.import_processor.exceptions import FileProcessingError, StateFieldError, ConfigurationError, \
    PdfConversionError
...
if __name__ == "__main__":
    ...
    init_state = {
        "pdf_path":r"C:\Users\22927\Desktop\参考文件\法律行业_专家试标任务说明（出题+rubric）(1).pdf",
        "file_dir":r"E:\output"
    }
    node_pdf_to_md = NodePDFToMD()
    #使用对象()的方式相当于调用了对象的__call__()
